#!/usr/bin/env python3
"""Run C2 pure logic and event-adapter tests. No Minecraft is started."""
...
def main():
 ...
 cmds=[('core',['node','--test','tests/core.test.js']),('runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/runtime.test.js']),('c2-core',['node','--test','tests/c2-core.test.js']),('c2-runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/c2-runtime.test.js'])];reports=[]
