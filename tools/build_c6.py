...
def main():
 ...
 for page in pages:
  if page['id']==N+':c5_effects':
   ...
   for lc in page['body']:page['body'][lc]+=('\nC6: Shriek Attack PvE, Upside Down, Vision and Tomb Raider adapters are now enabled. Five other types remain pending.'if lc=='en_US'else'\nC6更新：幽匿特調聲波、倒立、靈視與摸金校尉適配已接入，其他5種效果仍待實作。')
 ...
 coverage['scope']='Players as custom-effect owners; Shriek is PvE-only; Upside Down/Vision/Tomb Raider use explicit Bedrock adapters; other timed effects as C5'
