...
**C6不是聲稱其餘工作全部做完。** 原有41個機器配方不變；工作台合成由10個增至43個。效果狀態為血腥瑪麗規則實作，經驗汲取／Zenith／聲波／倒立四項明示適配；其餘7個Java效果仍未實作。
...
- 七種專屬效果：slightly_tipsy、high_heels、grass_stealth、vision、ardent_heat、long_reach、tomb_raider。
