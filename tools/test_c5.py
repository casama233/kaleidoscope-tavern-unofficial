#!/usr/bin/env python3
"""Run C5 accumulated logic and event-adapter tests. No Minecraft is started."""
...
def main():
 ...
 cmds=[('core',['node','--test','tests/core.test.js']),('runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/runtime.test.js']),('c2-core',['node','--test','tests/c2-core.test.js']),('c2-runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/c2-runtime.test.js']),('c3-core',['node','--test','tests/c3-core.test.js']),('c3-runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/c3-runtime.test.js']),('c4-core',['node','--test','tests/c4-core.test.js']),('c4-runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/c4-runtime.test.js']),('c5-core',['node','--test','tests/c5-core.test.js']),('c5-runtime',['node','--test','--experimental-loader','./tests/mock-loader.mjs','tests/c5-runtime.test.js'])];reports=[]
