export const MIXOLOGY_PAGES = [
  ...
  },
  {
    ...
    "body": {
      ...
      "zh_CN": "kaleidoscope_tavern:upside_down: 0s / amplifier 0 / 100% [C6 Grumm 倒立適配已接入；名稱牌待實機]",
  ...
  },
  {
    ...
    "body": {
      ...
      "zh_CN": "kaleidoscope_tavern:vision: 1800s / amplifier 0 / 100% [C6 靈視發光適配已接入；引擎驗收待執行]",
