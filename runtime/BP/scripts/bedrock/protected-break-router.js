 ...
 * Survival drops are spawned before the domain block/state commit; Creative discards recovery
 * outputs. Any spawn failure is observed by commitInventory before save(), so existing domain
 * rollback keeps the block/state intact.
 */
