...
def main():
 ...
 for lc in ['zh_TW','zh_CN','en_US']:
  ...
  for b in bindings:
   if b['kind'] in ['sofa','table','bar_counter','glassware_holder','holder','tilted_rack','circular_rack','bar_cabinet']:continue
 ...
 dump(R/'docs/C6-FURNITURE-BINDINGS.json',{'bindings':bindings,'derived_icons':icon_records,'stools':16,'lights':17,'sofas':16,'tables':1,'bar_counters':1,'glassware_holders':1,'holders':1,'pendant_lamps':3,'tilted_racks':1,'circular_racks':1,'paintings':14,'bar_cabinets':2,'engine_accepted':False})
 ...
 print('C6 generated: furniture, Holders/Racks, Paintings, wooden+glass Bar Cabinets and Pendant Lamps; official post-1.2 visual syncs retained (magenta light + gold grape texture + first c70eec cocktail cutout group).')
