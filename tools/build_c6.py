...
def main():
 ...
 for page in pages:
  if page['id']==N+':c6_furniture':
   page['title']={'zh_TW':'高腳凳、沙發與彩燈','zh_CN':'高脚凳、沙发与彩灯','en_US':'Stools, sofas and string lights'}
 ...
 dump(R/'docs/C6-FURNITURE-BINDINGS.json',{'bindings':bindings,'derived_icons':icon_records,'stools':16,'lights':17,'sofas':16,'engine_accepted':False})
 ...
 print('C6 generated: 16 stools, 16 source sofas and 17 light designs; official post-1.2 visual syncs retained (magenta light geometry + gold grape bucket texture).')
