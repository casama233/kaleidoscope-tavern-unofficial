...
system.run(()=>{
 try{
  ...
  console.warn('[Tavern C6] Cookery guide chapter and Tavern extension v1 initialized. Repair candidate 0.6.43-candidate.1.');
