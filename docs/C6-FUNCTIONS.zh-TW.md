...
- `core/custom-effects.js`：持續/瞬時自訂效果契約、Upside Down 嚴格AABB、Vision節點，以及 Tomb Raider 15目標與Java float32 30%判定。
...
- `tests/c6-core.test.js`／`tests/c6-runtime.test.js`：目前51個核心＋78個runtime案例，共129個C6回歸案例。
