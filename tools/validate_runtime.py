...
def main():
 ...
 check('native_furniture_placement_registry',"NATIVE_FURNITURE_PLACEMENT=Object.freeze(['table','glassware_holder'])" in (BP/'scripts/core/furniture.js').read_text(encoding='utf-8') and 'scriptedFurnitureItem' in furniture_text and "onPlace:e=>optional(()=>syncTableNeighborhood" in furniture_text)
