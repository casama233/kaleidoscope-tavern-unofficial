...
- `core/custom-effects.js`：持續/瞬時自訂效果契約、Upside Down 嚴格AABB相交，以及 Vision 半徑／50tick倒數節點。
...
- `tests/c6-core.test.js`／`tests/c6-runtime.test.js`：目前49個核心＋75個runtime案例，共124個C6回歸案例。
