...
def main():
 ...
 tap_block=load(BP/'blocks/tap.json');tap_block['minecraft:block']['permutations']=[{'condition':f"q.block_state('{NS}:open') == 1",'components':{'minecraft:geometry':{'identifier':'geometry.kt_assets_a1.tap_open'}}}];dump(BP/'blocks/tap.json',tap_block)
