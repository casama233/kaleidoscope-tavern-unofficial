...
def main():
 ...
 dump(R/'docs/C6-FURNITURE-BINDINGS.json',{'bindings':bindings,'derived_icons':icon_records,'stools':16,'lights':17,'sofas':16,'tables':1,'bar_counters':1,'glassware_holders':1,'pendant_lamps':3,'engine_accepted':False})
 ...
 print('C6 generated: stools, sofas, connected table/counter, four-slot Glassware Holder, three two-block Pendant Lamps and 17 light designs; official post-1.2 visual syncs retained (magenta light + gold grape texture + first c70eec cocktail cutout group).')
