...
def main():
 ...
 for page in pages:
  if page['id']==N+':c5_effects':
   ...
   for lc in page['body']:page['body'][lc]+=('\nC6: Shriek Attack PvE, Upside Down and Vision adapters are now enabled. Six other types remain pending.'if lc=='en_US'else'\nC6更新：幽匿特調聲波、倒立與靈視適配已接入，其他6種效果仍待實作。')
 ...
 coverage['scope']='Players as effect owners; Shriek is PvE-only; Upside Down and Vision use bounded Bedrock entity queries plus exact AABB checks; other timed effects as C5'
