...
def main():
 ...
 def recipe_ingredient(val):
  ...
  if tag=='minecraft:trapdoors':return {'item':'minecraft:oak_trapdoor'}
 ...
 chc={'format_version':'1.10.0','minecraft:client_entity':{'description':{'identifier':N+':cellar_cabinet_bottle_visual','materials':{'default':'entity_alphatest'},'textures':cht,'geometry':chg,'scripts':{'scale':'1.0'},'render_controllers':['controller.render.kt_runtime.cellar_cabinet_bottle']}}}
 ...
 for lc in ['zh_TW','zh_CN','en_US']:
  ...
  for b in bindings:
   if b['kind'] in ['sofa','table','bar_counter','glassware_holder','holder','tilted_rack','circular_rack','bar_cabinet','cellar_cabinet','incense']:continue
 ...
 dump(R/'docs/C6-FURNITURE-BINDINGS.json',{'bindings':bindings,'derived_icons':icon_records,'stools':16,'lights':17,'sofas':16,'tables':1,'bar_counters':1,'glassware_holders':1,'holders':1,'pendant_lamps':3,'tilted_racks':1,'circular_racks':1,'paintings':14,'bar_cabinets':2,'cellar_cabinets':1,'incenses':8,'engine_accepted':False})
 ...
 print('C6 generated: furniture, Holders/Racks, Paintings, Bar/Cellar Cabinets, eight Incense variants and Pendant Lamps; official post-1.2 visual syncs retained.')
