...
def main():
 ...
 for lc in ['zh_TW','zh_CN','en_US']:
  ...
  for b in bindings:
   if b['kind'] in ['sofa','table']:continue
 ...
 for page in pages:
  if page['id']==N+':c6_furniture':
   page['title']={'zh_TW':'高腳凳、沙發、桌子與彩燈','zh_CN':'高脚凳、沙发、桌子与彩灯','en_US':'Stools, sofas, tables and string lights'}
 ...
 dump(R/'docs/C6-FURNITURE-BINDINGS.json',{'bindings':bindings,'derived_icons':icon_records,'stools':16,'lights':17,'sofas':16,'tables':1,'engine_accepted':False})
 ...
 print('C6 generated: 16 stools, 16 source sofas, source-connected Tavern table and 17 light designs; official post-1.2 visual syncs retained (magenta light + gold grape texture + first c70eec cocktail cutout group).')
