...
def main():
 ...
 print('C6 generated: 16 native stools, 17 light designs, 33 source recipes and source-rendered icons; official post-1.2 visual syncs retained (magenta light geometry + gold grape bucket texture).')
